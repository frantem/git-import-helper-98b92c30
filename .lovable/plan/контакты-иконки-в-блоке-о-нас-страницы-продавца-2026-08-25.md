...
- Под текстом «О нас» — ряд круглых иконок (только для заполненных контактов):
  ...
  - **Viber** → `viber://chat?number=%2B{digits}?text=Здравствуйте! Пишу с вашего сайта на LOCUS` 
...
Выводить только те иконки контактов которые указал продавец в панели продавца которые остались пустые не выводить.
